// CS5 per docs/02-content/05-work-case-studies.md. Catering-led: multi-cuisine
// catering as the decisive comfort factor; menu governance across Jain, halal,
// regional Indian and Swiss tables. Strong gallery candidate.
import type { CaseStudyContent } from "@/content-schemas/types";

export const kitchenAt1560Metres: CaseStudyContent = {
  slug: "kitchen-at-1560-metres",
  order: 5,
  title: "The kitchen at 1,560 metres",
  ...
  hard: [
    ...
    "Kitchen capacity in Davos is contracted out months ahead, so the only kitchen you control is your own.",
  ],
  did: [
    "Ran our own multi-cuisine kitchens for the week rather than renting capacity we could not control.",
    "Planned menus with each delegation office in advance: cuisines, restrictions and the order of service.",
    "Held Jain and halal governance along the whole chain, from sourcing to separate preparation and service.",
    "Cooked regional Indian tables to taste of home, alongside Swiss tables that stand comparison locally.",
    "Staffed the pass for delegation rhythms: early departures, late bilaterals and meals that move without notice.",
    "Documented covers and menus for each client's own reporting.",
  ],
  outcome: {
    stats: [
      {
        value: "[TO CONFIRM: covers served]",
        label: "covers served across the week",
        verified: false,
      },
      {
        value: "[TO CONFIRM: menu lines run in parallel]",
        label: "menu lines run in parallel",
        verified: false,
      },
      {
        value: "[TO CONFIRM: consecutive days of full service]",
        label: "consecutive days of full service",
        verified: false,
      },
    ],
    summary:
      "The food is the comfort factor a hard week is remembered by, and it is the one thing we refuse to outsource. Covers and volumes await operations sign-off; the menus, and the governance behind them, are ours.",
  },
  gallery: [
    {
      slot: "cs5-01",
