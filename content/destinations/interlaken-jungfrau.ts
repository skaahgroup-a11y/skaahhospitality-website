...
export const interlakenJungfrau: DestinationContent = {
  ...
  whyGroups: [
    "Interlaken carries a particular resonance for Indian groups: this is Bollywood-heritage scenery, familiar to many guests before the flight is ever booked. For organisers, the practical appeal is just as strong: a single programme day can move from the waterline to high-alpine snow and be back at the hotel for dinner.",
  ],
  organiserFacts: [
    {
      title: "Two lakes, one high-alpine showpiece",
      description:
        "The town sits between two lakes with Europe's high-altitude rail showpiece above it, so water-level and high-alpine programme elements combine within a single day.",
    },
    {
      title: "Venues at both altitudes",
      description:
        "A congress hall in town plus alpine venues up the mountain give organisers plenary space and reward moments inside one region, without a change of base.",
    },
    {
      title: "Reaching it",
      description:
        "Around 2 h 15 from Zurich Airport by rail [TO CONFIRM: rail journey time]. On mountain days, luggage moves ahead by road so the group travels light.",
    },
  ],
  whatWeRun: [
    "Incentives",
