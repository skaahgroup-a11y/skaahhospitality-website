...
const sections: LegalSection[] = [
  {
    ...
    paragraphs: [
      "The controller for the personal data described on this page is SKAAH Hospitality GmbH, Opfikon (Zurich), Switzerland [TO CONFIRM: address, register no.]. SKAAH Hospitality GmbH is part of SKAAH Group AG.",
